...
namespace ProgressionExpanded
{
    public sealed class Settings : AttributeGlobalSettings<Settings>
    {
        ...
        [SettingPropertyBool("Enabled (needs restart)", Order = 0, RequireRestart = true,
        ...
        [SettingPropertyBool("Children are better than their parents", Order = 0, RequireRestart = false,
        ...
        [SettingPropertyGroup(Legacy, GroupOrder = 5)]
        ...
        [SettingPropertyBool("Use the custom progression curve (needs restart)", Order = 0, RequireRestart = true,
            HintText = "The heart of the mod: the XP curve, learning rates and ceilings. Turn this off to run with vanilla progression while keeping everything else. Reload the campaign after changing it.")]
        [SettingPropertyGroup(Trouble, GroupOrder = 6)]
        ...
        [SettingPropertyGroup(DebugGroup, GroupOrder = 7)]
